pipeline {
                ...
                withCredentials([usernamePassword(credentialsId: 'nexus-creds', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD')]) {
                    sh """
                        curl -u $USERNAME:$PASSWORD \
                          ...
                          http://3.83.241.115:30081/repository/maven-snapshots/com/project/staragile/medicure/0.0.1-SNAPSHOT/medicure-0.0.1-SNAPSHOT.jar
                    """
                }
            }
        }
    ...
    steps {
        ...
        sed -i 's|image: .*|image: 3.83.241.115:30091/medicure-app:${IMAGE_TAG}|' argocd/medicure-deploy.yml
